...
IF _FILEEXISTS("Z:\PhotoList.txt") = 0 OR AlwaysRefreshListing THEN
    ...
    SHELL "DIR " + PhotoList$ + "/b /s /a-d >Z:\PhotoList.txt"
END IF

OPEN "Z:\PhotoList.txt" FOR BINARY AS #1
DO UNTIL EOF(1)
    LINE INPUT #1, junk$
...
temp$ = "Z:\Wallpaper Changer Image.bmp"
